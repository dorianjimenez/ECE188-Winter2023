...
# sol = solution()
# print(sol.getNewURL("http://blog.ucla.edu/photo/api?token=73268f28ebb97395bd541685c3a94d31&user=Bob&command1=closePhoto&command2=logOut"))
...
h = md5(state=bytes.fromhex("41a166c915f60d99ee4f498557905e09"), count= bits)

x = "It is NOT"
h.update(x)
print(h.hexdigest())

y = m.encode("utf-8") + padding(len(m)*8) + x.encode("utf-8")
hh = md5()
hh.update(y)
print(hh.hexdigest())
'''